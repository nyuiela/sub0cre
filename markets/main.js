...
function handleCreateMarket(runtime2, payload) {
  ...
  const out = { status: "ok", result: "createMarket" };
...
var onHTTPTrigger = (runtime2, payload) => {
  ...
  runtime2.log("HTTP action must be 'createMarket' or 'seed'.");
  throw new Error("Missing or invalid body.action: use 'createMarket' or 'seed'");
};
